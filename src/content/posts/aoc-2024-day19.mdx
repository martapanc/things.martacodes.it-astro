...
<div className='flex flex-col gap-2'>
    <a
        className='gh-link'
        href='https://github.com/martapanc/Advent-of-Code/blob/master/2024-2025/src/2024/day19/day19.ts'
        target='_blank'
    >
        Day19 on GitHub
    </a>
    <a
        className='gh-link'
        href='https://github.com/martapanc/Advent-of-Code/blob/master/2024-2025/src/2024/README.md'
        target='_blank'
    >
        AoC 2024 Overview
    </a>
